...
celery_app.conf.update(
    ...
    # Result backend
    task_ignore_result=False,   # fixed typo (was task_ignore_resul)
    result_expires=86400,       # keep results around for a day, big jobs run long

    # Worker settings
    worker_concurrency=settings.CELERY_WORKER_CONCURRENCY,
    worker_prefetch_multiplier=1,  # don't hoard tasks — important for long-running work
